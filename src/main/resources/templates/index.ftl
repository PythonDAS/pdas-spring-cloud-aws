...
<html>
<head>
    <title>PythonDAS Spring Cloud AWS S3 upload</title>
    <meta charset="utf-8"/>
...
<table cellpadding="0" cellspacing="0" style="height:100%;width:100%;">
    ...
    <tr>
        <td valign="top" colspan="2" height="30"
            style="border-top: 2px solid #d8d8d8;background: #000;line-height: 28px;color:#fff;text-align: center;">
            PythonDAS spring cloud aws repository - <a href="https://github.com/PythonDAS/pythondas-spring-cloud-aws"
                                                       style="color: #fff;">https://github.com/PythonDAS/pythondas-spring-cloud-aws</a>
        </td>
    </tr>
</table>
